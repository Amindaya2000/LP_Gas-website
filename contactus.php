...
if ($stmt->execute()) {
    ...
    try {
        ...
        $mail->Username   = 'amindyaperera@gmail.com';                // Your Gmail address
        $mail->Password   = 'qawy iqbw bfaq qdos';                   // Your Gmail app password
        ...
        //Recipients
        $mail->setFrom('amindyaperera@gmail.com', 'online booking contact mail');
        $mail->addAddress('ridmiperera265@gmail.com');                    // Add a recipient
        //$mail->addAddress('anushka@gammainterpharm.lk');
        // Content
